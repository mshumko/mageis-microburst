...
gs = gridspec.GridSpec(len(energies)+2, 15)

ax = (len(energies)+2)*[None]
...
for E in energies:
    ...
    ax[-1].plot(flatTime[validIdf], flatFlux[validIdf], 
        label = '{} < E < {} keV'.format(Elow[E], Ehigh[E]), lw = 1)
